...
import com.notarmaso.beeritup.ui.theme.components.TextFieldPhone
...
fun AddUser(addUserViewModel: AddUserViewModel) {
    ...
    ConstraintLayout(
        ...
        Text(text = stringResource(R.string.createUserTitle),
            fontSize = 38.sp, textDecoration = TextDecoration.Underline, style =  MaterialTheme.typography.h1,
